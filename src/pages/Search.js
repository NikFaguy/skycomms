...
const Search = () => {
    ...
    const handleSubmit = (event) => {
        ...
        const fetchData = async () => {
            try {
                ...
                const response = await fetch('https://skycomms-api.onrender.com/discussion/search/' + recherche);
    ...
    const handleCategoryChange = (event) => {
        ...
        const fetchData = async () => {
            try {
                const response = await fetch('https://skycomms-api.onrender.com/discussion/search/' + event.target.value);
                const discussionsData = await response.json();
