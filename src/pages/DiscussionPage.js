...
const DiscussionPage = () => {
    ...
    const davantageDeDiscussions = async () => {
        ...
        try {
            const response = await fetch('https://skycomms-api.onrender.com/discussion/discussions-supplementaires/' + discussion.category + '/' + discussion._id,
                {
                    method: 'GET',
                    headers: {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await fetch(`https://skycomms-api.onrender.com/discussion/${id}`);
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await fetch(`https://skycomms-api.onrender.com/comment/comments/${id}`);
    ...
    const handlePostComment = async (event) => {
        ...
        try {
            const response = await fetch(`https://skycomms-api.onrender.com/comment/create/${id}`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${user.token}`
    ...
    const handleSaveEditedComment = async (commentId, newText) => {
        ...
        try {
            const response = await fetch(`https://skycomms-api.onrender.com/comment/update/${commentId}`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${user.token}`
    ...
    const handleDeleteComment = async (commentId) => {
        try {
            const response = await fetch(`https://skycomms-api.onrender.com/comment/delete/${commentId}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${user.token}`
    ...
    const handleUpvote = (commentId) => async () => {
        try {
            const response = await fetch(`https://skycomms-api.onrender.com/comment/upvote/${commentId}`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${user.token}`
    ...
    const handleDownvote = (commentId) => async () => {
        try {
            const response = await fetch(`https://skycomms-api.onrender.com/comment/downvote/${commentId}`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${user.token}`
